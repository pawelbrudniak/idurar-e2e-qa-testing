...
Process:
Analyze application behavior and identify critical flows
Design test cases based on real user scenarios
Execute manual tests via UI
Validate API behavior using Postman
Verify data directly in MongoDB (mongosh)
Report defects with detailed steps and evidence
🖥️ Test Environment
VPS: Contabo (Ubuntu)
